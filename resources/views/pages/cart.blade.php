        ...
        <div class="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 20%;">
                                    ...
                                    <img src="{{ Storage::url($cart->product->galleries->first()->photo) }}" alt=""
                                        class="cart-image">
                                    @endif
                                </td>
                                <td style="width: 35%;">
                                    <div class="product-tittle">{{ $cart->product->name }}</div>
                                    <div class="product-subtittle">By {{ $cart->product->user->store_name }}</div>
                                </td>
                                <td style="width: 35%;">
            ...
            <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="form-control" v-else></select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-4 col-md-2">
                        <div class="product-tittle text-success">
